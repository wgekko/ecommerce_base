                  ...
                  {allOrdersForAllUsers.map((item) => (
                    ...
                    >
                      ...
                      <div className="flex gap-5">
                        <button className="disabled:opacity-50 mt-5 mr-5  inline-block bg-[#003B46] text-white px-5 py-3 text-xs font-medium uppercase tracking-wide">
                          {item.isProcessing
                            ? "Order is Processing"
                            : "Order is delivered"}
                        </button>
                        <button
                          ...
                          className="disabled:opacity-50 mt-5 mr-5  inline-block bg-[#003B46] text-white px-5 py-3 text-xs font-medium uppercase tracking-wide"
                        >
                          {componentLevelLoader &&
