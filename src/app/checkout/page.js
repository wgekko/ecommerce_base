            ...
            <div className="bg-white shadow">
              <div className="px-4 py-6 sm:px-8 sm:py-10 flex flex-col gap-5">
                <h1 className="font-bold text-lg">
                    Su pago fue exitoso y será redirigido a
    ...
    <div>
      <div className="grid sm:px-10 lg:grid-cols-2 lg:px-20 xl:px-32">
        ...
        <div className="mt-10 bg-gray-50 px-4 pt-8 lg:mt-0">
          <p className="text-xl font-medium">Detalle de dirección de envio</p>
          <p className="text-gray-400 font-bold">
              Complete su pedido seleccionando la dirección a continuación
          </p>
          ...
          <div className="mt-6 border-t border-b py-2">
            ...
            <div className="pb-10">
              <button
                ...
                className="disabled:opacity-50 mt-5 mr-5 w-full  inline-block bg-[#003B46] text-white px-5 py-3 text-xs font-medium uppercase tracking-wide"
              >
                Verificar
              </button>
            </div>
